...
# Process additional custom test environement
TEST_CUSTOM_ENV_ARGS=''
for(TEST_CUSTOM_ENV_ENTRY, TEST_CUSTOM_ENV) : TEST_CUSTOM_ENV_ARGS += "--custom-env $${TEST_CUSTOM_ENV_ENTRY}"

TEST_ARGS="TESTARGS=\"$${TEST_LIB_PATH_ARGS} $${TEST_FRAMEWORK_PATH_ARGS} $${TEST_VERBOSE_TEXT} $${TEST_CUSTOM_ENV_ARGS}\""
